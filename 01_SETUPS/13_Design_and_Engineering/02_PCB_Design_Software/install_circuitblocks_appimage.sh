...
#######################################################################
# File Name    : install_circuitblocks_appimage.sh
...
#                  chmod +x install_circuitblocks_appimage.sh
#                • Run the script with:
#                  bash install_circuitblocks_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/circuitblocks/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/circuitblocks/remove.sh
...
# Define variables
APP_NAME="circuitblocks"
APP_DOWNLOAD_URL="https://api.github.com/repos/CircuitMess/CircuitBlocks/releases"
