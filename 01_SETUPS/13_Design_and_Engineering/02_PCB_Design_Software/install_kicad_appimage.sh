...
#######################################################################
# File Name    : install_kicad_appimage.sh
...
#                  chmod +x install_kicad_appimage.sh
#                • Run the script with:
#                  bash install_kicad_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/kicad/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/kicad/remove.sh
...
# Define variables
APP_NAME="kicad"
APP_DOWNLOAD_URL="https://api.github.com/repos/KarlZeilhofer/kicad-appimage/releases"
