...
#######################################################################
# File Name    : install_gerbv_appimage.sh
...
#                  chmod +x install_gerbv_appimage.sh
#                • Run the script with:
#                  bash install_gerbv_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/gerbv/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/gerbv/remove.sh
...
# Define variables
APP_NAME="gerbv"
APP_DOWNLOAD_URL="https://api.github.com/repos/m59peacemaker/gerbv-appimage/releases"
