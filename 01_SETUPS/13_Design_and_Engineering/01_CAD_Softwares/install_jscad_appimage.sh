...
#######################################################################
# File Name    : install_jscad_appimage.sh
...
#                  chmod +x install_jscad_appimage.sh
#                • Run the script with:
#                  bash install_jscad_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/jscad/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/jscad/remove.sh
...
# Define variables
APP_NAME="jscad"
APP_DOWNLOAD_URL="https://api.github.com/repos/jscad/jscad-desktop/releases"
