...
#######################################################################
# File Name    : install_freecad_assembly3_appimage.sh
...
#                  chmod +x install_freecad_assembly3_appimage.sh
#                • Run the script with:
#                  bash install_freecad_assembly3_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/freecad-assembly3/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/freecad-assembly3/remove.sh
...
# Define variables
APP_NAME="freecad-assembly3"
APP_DOWNLOAD_URL="https://api.github.com/repos/realthunder/FreeCAD/releases"
