...
#######################################################################
# File Name    : install_freecad_appimage.sh
...
#                  chmod +x install_freecad_appimage.sh
#                • Run the script with:
#                  bash install_freecad_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/freecad/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/freecad/remove.sh
...
# Define variables
APP_NAME="freecad"
APP_DOWNLOAD_URL="https://api.github.com/repos/FreeCAD/FreeCAD-Bundle/releases"
