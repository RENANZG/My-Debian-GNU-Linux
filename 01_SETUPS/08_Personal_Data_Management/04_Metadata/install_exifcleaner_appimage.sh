...
#######################################################################
# File Name    : install_exifcleaner_appimage.sh
...
#                  chmod +x install_exifcleaner_appimage.sh
#                • Run the script with:
#                  bash install_exifcleaner_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/exifcleaner/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/exifcleaner/remove.sh
...
# Define variables
APP_NAME="exifcleaner"
APP_DOWNLOAD_URL="https://api.github.com/repos/szTheory/exifcleaner/releases"
