...
#######################################################################
# File Name    : install_jexiftoolgui_appimage.sh
...
#                  chmod +x install_jexiftoolgui_appimage.sh
#                • Run the script with:
#                  bash install_jexiftoolgui_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/jexiftoolgui/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/jexiftoolgui/remove.sh
...
# Define variables
APP_NAME="jexiftoolgui"
APP_DOWNLOAD_URL="https://api.github.com/repos/hvdwolf/jExifToolGUI/releases"
