...
#######################################################################
# File Name    : install_vup_appimage.sh
...
#                  chmod +x install_vup_appimage.sh
#                • Run the script with:
#                  bash install_vup_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/vup/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/vup/remove.sh
...
# Define variables
APP_NAME="vup"
APP_DOWNLOAD_URL="https://api.github.com/repos/vup-app/vup/releases"
