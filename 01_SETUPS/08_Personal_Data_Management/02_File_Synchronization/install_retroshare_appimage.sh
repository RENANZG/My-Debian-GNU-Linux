...
#######################################################################
# File Name    : install_retroshare_appimage.sh
...
#                  chmod +x install_retroshare_appimage.sh
#                • Run the script with:
#                  bash install_._appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/retroshare/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/retroshare/remove.sh
...
# Define variables
APP_NAME="retroshare"
APP_DOWNLOAD_URL="https://api.github.com/repos/RetroShare/RetroShare/releases"
