...
#######################################################################
# File Name    : install_cryptomator_appimage.sh
...
#                  chmod +x install_cryptomator_appimage.sh
#                • Run the script with:
#                  bash install_cryptomator_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/cryptomator/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/cryptomator/remove.sh
...
APP_DOWNLOAD_URL="https://api.github.com/repos/cryptomator/cryptomator/releases"
