...
#######################################################################
# File Name    : install_rclone_browser_appimage.sh
...
#                  chmod +x install_rclone_browser_appimage.sh
#                • Run the script with:
#                  bash install_rclone_browser_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/rclone-browser/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/rclone-browser/remove.sh
...
APP_DOWNLOAD_URL="https://api.github.com/repos/kapitainsky/RcloneBrowser/releases"
