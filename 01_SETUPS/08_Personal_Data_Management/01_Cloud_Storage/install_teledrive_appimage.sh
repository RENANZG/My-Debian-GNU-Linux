...
#######################################################################
# File Name    : install_teledrive_appimage.sh
...
#                  chmod +x install_teledrive_appimage.sh
#                • Run the script with:
#                  bash install_teledrive_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/teledrive/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/teledrive/remove.sh
...
# Define variables
APP_NAME="teledrive"
APP_DOWNLOAD_URL="https://api.github.com/repos/KhushrajRathod/TeleDrive/releases"
