...
#######################################################################
# File Name    : install_mark_mind_appimage.sh
...
#                  chmod +x install_mark_mind_appimage.sh
#                • Run the script with:
#                  bash install_mark_mind_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/mark-mind/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/mark-mind/remove.sh
...
# Define variables
APP_NAME="mark-mind"
APP_DOWNLOAD_URL="https://api.github.com/repos/MarkMindLtd/Mark-Mind/releases"
