...
#######################################################################
# File Name    : install_meshmill_appimage.sh
...
#                  chmod +x install_meshmill_appimage.sh
#                • Run the script with:
#                  bash install_meshmill_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/meshmill/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/meshmill/remove.sh
...
# Define variables
APP_NAME="meshmill"
APP_DOWNLOAD_URL="https://api.github.com/repos/jes/meshmill/releases"
