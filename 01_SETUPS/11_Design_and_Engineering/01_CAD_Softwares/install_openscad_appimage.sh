...
#######################################################################
# File Name    : install_openscad_appimage.sh
...
#                  chmod +x install_openscad_appimage.sh
#                • Run the script with:
#                  bash install_openscad_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/openscad/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/openscad/remove.sh
...
# Define variables
APP_NAME="openscad"
APP_DOWNLOAD_URL="https://api.github.com/repos/openscad/openscad/releases"
