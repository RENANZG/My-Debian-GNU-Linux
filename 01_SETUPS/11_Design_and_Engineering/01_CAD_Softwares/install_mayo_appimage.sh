...
#######################################################################
# File Name    : install_mayo_appimage.sh
...
#                  chmod +x install_mayo_appimage.sh
#                • Run the script with:
#                  bash install_mayo_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/mayo/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/mayo/remove.sh
...
# Define variables
APP_NAME="mayo"
APP_DOWNLOAD_URL="https://api.github.com/repos/fougue/mayo/releases"
