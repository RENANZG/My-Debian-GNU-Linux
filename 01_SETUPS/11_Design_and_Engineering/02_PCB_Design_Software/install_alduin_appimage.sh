...
#######################################################################
# File Name    : install_alduin_appimage.sh
...
#                  chmod +x install_alduin_appimage.sh
#                • Run the script with:
#                  bash install_alduin_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/alduin/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/alduin/remove.sh
...
# Define variables
APP_NAME="alduin"
APP_DOWNLOAD_URL="https://api.github.com/repos/Xstoudi/alduin/releases"
