...
#######################################################################
# File Name    : install_embedded_ide_appimage.sh
...
#                  chmod +x install_embedded_ide_appimage.sh
#                • Run the script with:
#                  bash install_embedded_ide_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/embedded-ide/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/embedded-ide/remove.sh
...
# Define variables
APP_NAME="embedded-ide"
APP_DOWNLOAD_URL="https://api.github.com/repos/martinribelotta/embedded-ide/releases"
