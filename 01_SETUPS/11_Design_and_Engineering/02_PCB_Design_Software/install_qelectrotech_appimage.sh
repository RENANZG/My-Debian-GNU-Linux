...
#######################################################################
# File Name    : install_qelectrotech_appimage.sh
...
#                  chmod +x install_qelectrotech_appimage.sh
#                • Run the script with:
#                  bash install_qelectrotech_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/qelectrotech/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/qelectrotech/remove.sh
...
# Define variables
APP_NAME="qelectrotech"
APP_DOWNLOAD_URL="https://api.github.com/repos/qelectrotech/qelectrotech-source-mirror/releases"
