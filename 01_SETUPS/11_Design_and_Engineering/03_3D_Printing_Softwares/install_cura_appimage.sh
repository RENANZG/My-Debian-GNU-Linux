...
#######################################################################
# File Name    : install_cura_appimage.sh
...
#                  chmod +x install_cura_appimage.sh
#                • Run the script with:
#                  bash install_cura_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/cura/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/cura/remove.sh
