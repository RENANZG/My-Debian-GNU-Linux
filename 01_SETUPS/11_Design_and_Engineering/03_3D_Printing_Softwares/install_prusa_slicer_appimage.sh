...
#######################################################################
# File Name    : install_prusa_slicer_appimage.sh
...
#                  chmod +x install_prusa_slicer_appimage.sh
#                • Run the script with:
#                  bash install_prusa_slicer_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/prusa-slicer/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/prusa-slicer/remove.sh
...
# Define variables
APP_NAME="prusa-slicer"
APP_DOWNLOAD_URL="https://api.github.com/repos/prusa3d/PrusaSlicer/releases"
