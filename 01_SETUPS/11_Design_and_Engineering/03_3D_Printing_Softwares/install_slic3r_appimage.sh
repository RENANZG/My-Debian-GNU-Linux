...
#######################################################################
# File Name    : install_slic3r_appimage_appimage.sh
...
#                  chmod +x install_slic3r_appimage_appimage.sh
#                • Run the script with:
#                  bash install_slic3r_appimage_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/slic3r-appimage/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/slic3r-appimage/remove.sh
...
# Define variables
APP_NAME="slic3r-appimage"
APP_DOWNLOAD_URL="https://api.github.com/repos/slic3r/Slic3r/releases"
