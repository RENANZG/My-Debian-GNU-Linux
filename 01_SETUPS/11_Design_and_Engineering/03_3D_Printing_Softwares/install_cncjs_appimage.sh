...
#######################################################################
# File Name    : install_cncjs_appimage.sh
...
#                  chmod +x install_cncjs_appimage.sh
#                • Run the script with:
#                  bash install_cncjs_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/cncjs/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/cncjs/remove.sh
...
# Define variables
APP_NAME="cncjs"
APP_DOWNLOAD_URL="https://api.github.com/repos/cncjs/cncjs/releases"
