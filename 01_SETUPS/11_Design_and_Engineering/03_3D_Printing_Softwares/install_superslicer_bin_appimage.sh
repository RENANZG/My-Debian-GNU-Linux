...
#######################################################################
# File Name    : install_superslicer_bin_appimage.sh
...
#                  chmod +x install_superslicer_bin_appimage.sh
#                • Run the script with:
#                  bash install_superslicer_bin_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/superslicer-bin/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/superslicer-bin/remove.sh
