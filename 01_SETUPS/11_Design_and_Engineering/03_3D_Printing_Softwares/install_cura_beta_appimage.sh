...
#######################################################################
# File Name    : install_cura_beta_appimage.sh
...
#                  chmod +x install_cura_beta_appimage.sh
#                • Run the script with:
#                  bash install_cura_beta_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/cura-beta/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/cura-beta/remove.sh
...
# Define variables
APP_NAME="cura-beta"
APP_DOWNLOAD_URL="https://api.github.com/repos/Ultimaker/Cura/releases"
