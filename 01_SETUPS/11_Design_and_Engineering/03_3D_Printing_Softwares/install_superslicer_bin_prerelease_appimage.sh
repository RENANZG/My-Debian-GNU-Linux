...
#######################################################################
# File Name    : install_superslicer_prerelease_bin_appimage.sh
...
#                  chmod +x install_superslicer_prerelease_bin_appimage.sh
#                • Run the script with:
#                  bash install_superslicer_prerelease_bin_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/superslicer-prerelease-bin/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/superslicer-prerelease-bin/remove.sh
...
# Define variables
APP_NAME="superslicer-prerelease-bin"
APP_DOWNLOAD_URL="https://api.github.com/repos/supermerill/SuperSlicer/releases"
