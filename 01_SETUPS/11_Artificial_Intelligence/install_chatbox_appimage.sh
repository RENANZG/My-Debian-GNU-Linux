...
#######################################################################
# File Name    : install_chatbox_appimage.sh
...
#                  chmod +x install_chatbox_appimage.sh
#                • Run the script with:
#                  bash install_chatbox_appimage.sh
#                • To update the AppImage, run:
#                  bash $HOME/.local/share/chatbox/update.sh
#                • To remove the AppImage, run:
#                  bash $HOME/.local/share/chatbox/remove.sh
...
# Define variables
APP_NAME="chatbox"
APP_DOWNLOAD_URL="https://api.github.com/repos/Bin-Huang/chatbox/releases"
