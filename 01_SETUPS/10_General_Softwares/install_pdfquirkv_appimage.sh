...
#######################################################################
# File Name    : install_pdfquirk_appimage.sh
...
#                  chmod +x install_pdfquirk_appimage.sh
#                • Run the script with:
#                  bash install_pdfquirk_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/pdfquirk/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/pdfquirk/remove.sh
...
# Define variables
APP_NAME="pdfquirk"
APP_DOWNLOAD_URL="https://api.github.com/repos/dragotin/pdfquirk/releases"
