...
#######################################################################
# File Name    : install_balena_etcher_appimage.sh
...
#                  chmod +x install_balena_etcher_appimage.sh
#                • Run the script with:
#                  bash install_balena_etcher_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/balena-etcher/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/balena-etcher/remove.sh
...
APP_DOWNLOAD_URL="https://api.github.com/repos/balena-io/etcher/releases"
