...
#######################################################################
# File Name    : install_featerwallet_appimage.sh
...
#                  chmod +x install_featerwallet_appimage.sh
#                • Run the script with:
#                  bash install_featerwallet_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/featerwallet/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/featerwallet/remove.sh
...
# Define variables
APP_NAME="featerwallet"
APP_DOWNLOAD_URL="https://featherwallet.org"
