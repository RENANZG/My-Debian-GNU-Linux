...
#######################################################################
# File Name    : install_deezer_appimage.sh
...
#                  chmod +x install_deezer_appimage.sh
#                • Run the script with:
#                  bash install_deezer_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/deezer/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/deezer/remove.sh
...
# Define variables
APP_NAME="deezer"
APP_DOWNLOAD_URL="https://api.github.com/repos/aunetx/deezer-linux/releases"
