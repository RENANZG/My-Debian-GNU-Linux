...
#######################################################################
# File Name    : install_vscodium_appimage.sh
...
#                  chmod +x install_vscodium_appimage.sh
#                • Run the script with:
#                  bash install_vscodium_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/vscodium/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/vscodium/remove.sh
...
# Define variables
APP_NAME="vscodium"
APP_DOWNLOAD_URL="https://api.github.com/repos/VSCodium/vscodium/releases"
