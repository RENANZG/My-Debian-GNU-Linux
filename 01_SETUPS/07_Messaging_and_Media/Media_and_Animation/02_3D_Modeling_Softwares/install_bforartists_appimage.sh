...
#######################################################################
# File Name    : install_bforartists_appimage.sh
...
#                  chmod +x install_bforartists_appimage.sh
#                • Run the script with:
#                  bash install_bforartists_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/bforartists/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/bforartists/remove.sh
...
APP_DOWNLOAD_URL="https://api.github.com/repos/Bforartists/Bforartists/releases"
