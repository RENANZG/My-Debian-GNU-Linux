...
#######################################################################
# File Name    : install_subtitler_appimage.sh
...
#                  chmod +x install_subtitler_appimage.sh
#                • Run the script with:
#                  bash install_subtitler_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/subtitler/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/subtitler/remove.sh
...
# Define variables
APP_NAME="subtitler"
APP_DOWNLOAD_URL="https://api.github.com/repos/s8sachin/subtitler/releases"
