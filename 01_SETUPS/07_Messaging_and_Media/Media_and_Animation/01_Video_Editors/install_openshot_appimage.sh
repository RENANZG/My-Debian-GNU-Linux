...
#######################################################################
# File Name    : install_openshot_appimage.sh
...
#                  chmod +x install_openshot_appimage.sh
#                • Run the script with:
#                  bash install_openshot_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/openshot/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/openshot/remove.sh
...
# Define variables
APP_NAME="openshot"
APP_DOWNLOAD_URL="https://api.github.com/repos/OpenShot/openshot-qt/releases"
