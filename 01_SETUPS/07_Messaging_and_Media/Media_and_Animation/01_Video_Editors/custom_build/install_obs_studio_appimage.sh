...
#######################################################################
# File Name    : install_obs_studio_appimage.sh
...
#                  chmod +x install_obs_studio_appimage.sh
#                • Run the script with:
#                  bash install_obs_studio_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/obs-studio/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/obs-studio/remove.sh
...
# Define variables
APP_NAME="obs-studio"
APP_DOWNLOAD_URL="https://api.github.com/repos/ivan-hc/OBS-Studio-appimage/releases"
