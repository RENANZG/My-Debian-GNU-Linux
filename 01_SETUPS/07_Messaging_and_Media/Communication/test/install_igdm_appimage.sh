...
#######################################################################
# File Name    : install_igdm_appimage.sh
...
#                  chmod +x install_igdm_appimage.sh
#                • Run the script with:
#                  bash install_igdm_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/igdm/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/igdm/remove.sh
...
# Define variables
APP_NAME="igdm"
APP_DOWNLOAD_URL="https://api.github.com/repos/ifedapoolarewaju/igdm/releases"
