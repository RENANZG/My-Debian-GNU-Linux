...
#######################################################################
# File Name    : install_fraidycat_appimage.sh
...
#                  chmod +x install_fraidycat_appimage.sh
#                • Run the script with:
#                  bash install_fraidycat_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/fraidycat/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/fraidycat/remove.sh
...
APP_NAME="fraidycat"
APP_DOWNLOAD_URL="https://api.github.com/repos/kickscondor/fraidycat/releases"
