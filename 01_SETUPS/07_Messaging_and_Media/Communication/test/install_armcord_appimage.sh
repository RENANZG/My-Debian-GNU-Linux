...
#######################################################################
# File Name    : install_armcord_appimage.sh
...
#                  chmod +x install_armcord_appimage.sh
#                • Run the script with:
#                  bash install_armcord_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/armcord/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/armcord/remove.sh
...
APP_NAME="armcord"
APP_DOWNLOAD_URL="https://api.github.com/repos/ArmCord/ArmCord/releases"
