...
#######################################################################
# File Name    : install_xchat_appimage.sh
...
#                  chmod +x install_xchat_appimage.sh
#                • Run the script with:
#                  bash install_xchat_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/xchat/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/xchat/remove.sh
...
# Define variables
APP_NAME="xchat"
APP_DOWNLOAD_URL="https://api.github.com/repos/probonopd/XChat/releases"
