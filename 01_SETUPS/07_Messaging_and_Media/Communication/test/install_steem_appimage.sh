...
#######################################################################
# File Name    : install_steem_messenger_appimage.sh
...
#                  chmod +x install_steem_messenger_appimage.sh
#                • Run the script with:
#                  bash install_steem_messenger_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/steem-messenger/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/steem-messenger/remove.sh
...
# Define variables
APP_NAME="steem-messenger"
APP_DOWNLOAD_URL="https://api.github.com/repos/therealwolf42/steemmessenger/releases"
