...
#######################################################################
# File Name    : install_ricochet_refresh_appimage.sh
...
#                  chmod +x install_ricochet_refresh_appimage.sh
#                • Run the script with:
#                  bash install_ricochet_refresh_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/ricochet-refresh/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/ricochet-refresh/remove.sh
...
# Define variables
APP_NAME="ricochet-refresh"
APP_DOWNLOAD_URL="https://api.github.com/repos/blueprint-freespeech/ricochet-refresh/releases"
