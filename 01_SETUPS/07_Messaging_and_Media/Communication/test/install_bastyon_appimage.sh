...
#######################################################################
# File Name    : install_bastyon_appimage.sh
...
#                  chmod +x install_bastyon_appimage.sh
#                • Run the script with:
#                  bash install_bastyon_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/bastyon/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/bastyon/remove.sh
...
# Define variables
APP_NAME="bastyon"
APP_DOWNLOAD_URL="https://api.github.com/repos/pocketnetteam/pocketnet.gui/releases"
