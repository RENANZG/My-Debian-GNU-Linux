...
#######################################################################
# File Name    : install_kaidan_appimage.sh
...
#                  chmod +x install_kaidan_appimage.sh
#                • Run the script with:
#                  bash install_kaidan_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/kaidan/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/kaidan/remove.sh
...
# Define variables
APP_NAME="kaidan"
APP_DOWNLOAD_URL="https://api.github.com/repos/KaidanIM/Kaidan/releases"
