...
#######################################################################
# File Name    : install_session_appimage.sh
...
#                  chmod +x install_session_appimage.sh
#                • Run the script with:
#                  bash install_session_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/session-desktop/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/session-desktop/remove.sh
...
# Define variables
APP_NAME="session-desktop"
APP_DOWNLOAD_URL="https://api.github.com/repos/oxen-io/session-desktop/releases"
