...
########################################################################
# File Name    : install_simplex_appimage.sh
...
#                  chmod +x install_simplex_appimage.sh
#                • Run the script with:
#                  bash install_simplex_appimage.sh
#                • To update the AppImage, run:
#                  bash $HOME/.local/share/simplex/update.sh
#                • To remove the AppImage, run:
#                  bash $HOME/.local/share/simplex/remove.sh
