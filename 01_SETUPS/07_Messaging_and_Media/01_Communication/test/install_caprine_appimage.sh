...
#######################################################################
# File Name    : install_caprine_appimage.sh
...
#                  chmod +x install_caprine_appimage.sh
#                • Run the script with:
#                  bash install_caprine_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/caprine/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/caprine/remove.sh
...
# Define variables
APP_NAME="caprine"
APP_DOWNLOAD_URL="https://api.github.com/repos/sindresorhus/caprine/releases"
