...
#######################################################################
# File Name    : install_thedesk_appimage.sh
...
#                  chmod +x install_thedesk_appimage.sh
#                • Run the script with:
#                  bash install_thedesk_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/thedesk/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/thedesk/remove.sh
...
# Define variables
APP_NAME="thedesk"
APP_DOWNLOAD_URL="https://api.github.com/repos/cutls/TheDesk/releases"
