...
#######################################################################
# File Name    : install_botclient_discord_appimage.sh
...
#                  chmod +x install_botclient_discord_appimage.sh
#                • Run the script with:
#                  bash install_botclient_discord_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/botclient-discord/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/botclient-discord/remove.sh
...
# Define variables
APP_NAME="botclient-discord"
APP_DOWNLOAD_URL="https://api.github.com/repos/DarkGuy10/BotClient/releases"
