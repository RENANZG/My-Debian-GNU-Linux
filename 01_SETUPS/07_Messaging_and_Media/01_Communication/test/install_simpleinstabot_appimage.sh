...
#######################################################################
# File Name    : install_simpleinstabot_appimage.sh
...
#                  chmod +x install_simpleinstabot_appimage.sh
#                • Run the script with:
#                  bash install_simpleinstabot_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/simpleinstabot/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/simpleinstabot/remove.sh
...
# Define variables
APP_NAME="simpleinstabot"
APP_DOWNLOAD_URL="https://api.github.com/repos/mifi/SimpleInstaBot/releases"
