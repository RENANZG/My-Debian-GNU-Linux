...
#######################################################################
# File Name    : install_goofcord_appimage.sh
...
#                  chmod +x install_goofcord_appimage.sh
#                • Run the script with:
#                  bash install_goofcord_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/goofcord/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/goofcord/remove.sh
...
APP_NAME="goofcord"
APP_DOWNLOAD_URL="https://api.github.com/repos/Milkshiift/GoofCord/releases"
