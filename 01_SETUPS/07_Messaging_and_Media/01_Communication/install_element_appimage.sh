...
#######################################################################
# File Name    : install_element_appimage.sh
...
#                  chmod +x install_element_appimage.sh
#                • Run the script with:
#                  bash install_element_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/element/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/element/remove.sh
...
# Define variables
APP_NAME="element"
APP_DOWNLOAD_URL="https://api.github.com/repos/srevinsaju/element-appimage/releases"
