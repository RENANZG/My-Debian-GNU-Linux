...
#######################################################################
# File Name    : install_dust3d_appimage.sh
...
#                  chmod +x install_dust3d_appimage.sh
#                • Run the script with:
#                  bash install_dust3d_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/dust3d/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/dust3d/remove.sh
...
# Define variables
APP_NAME="dust3d"
APP_DOWNLOAD_URL="https://api.github.com/repos/huxingyi/dust3d/releases"
