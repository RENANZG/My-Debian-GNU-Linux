...
#######################################################################
# File Name    : install_gsubs_appimage.sh
...
#                  chmod +x install_gsubs_appimage.sh
#                • Run the script with:
#                  bash install_gsubs_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/gsubs/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/gsubs/remove.sh
...
# Define variables
APP_NAME="gsubs"
APP_DOWNLOAD_URL="https://api.github.com/repos/sanjevirau/gsubs/releases"
