...
#######################################################################
# File Name    : install_alvr_appimage.sh
...
#                  chmod +x install_alvr_appimage.sh
#                • Run the script with:
#                  bash install_alvr_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/alvr/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/alvr/remove.sh
...
# Define variables
APP_NAME="alvr"
APP_DOWNLOAD_URL="https://api.github.com/repos/elpinguinoopensource/alvr-appimage/releases"
