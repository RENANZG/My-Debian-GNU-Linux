...
#######################################################################
# File Name    : install_vircadia_appimage.sh
...
#                  chmod +x install_vircadia_appimage.sh
#                • Run the script with:
#                  bash install_vircadia_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/vircadia/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/vircadia/remove.sh
...
# Define variables
APP_NAME="vircadia"
APP_DOWNLOAD_URL="https://api.github.com/repos/vircadia/vircadia-native-core/releases"
