...
#######################################################################
# File Name    : install_overte_appimage.sh
...
#                  chmod +x install_overte_appimage.sh
#                • Run the script with:
#                  bash install_overte_appimage.sh
#                • To update, run:
#                  bash $HOME/.local/share/overte/update.sh
#                • To remove, run:
#                  bash $HOME/.local/share/overte/remove.sh
...
# Define variables
APP_NAME="overte"
APP_DOWNLOAD_URL="https://api.github.com/repos/overte-org/overte/releases"
