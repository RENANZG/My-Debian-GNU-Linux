...
<tbody>
  ...
  <tr>
    ...
    <td>sudo apt install cherrytree</td>
    <td>sudo apt install zim</td>
    <td>sudo apt install xournalpp</td>
    <td>sudo apt install rednotebook</td>
    <td>sudo apt install feathernotes</td>
    <td>sudo apt install featherpad</td>
  </tr>
  <tr>
    <td>Dependencies</td>
    <td>GTK+, libgtkmm</td>
