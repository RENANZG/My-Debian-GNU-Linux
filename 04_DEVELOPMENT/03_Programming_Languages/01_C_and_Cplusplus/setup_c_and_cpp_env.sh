...
echo "1) GNU Compiler Collection (GCC) with GDB (GNU Debugger): A widely-used compiler."
...
case $compiler_choice in
  ...
  3)
    ...
    echo "Installing GDB (GNU Debugger) for GCC..."
    sudo apt install -y gdb  # Install debugger (GDB) for GCC
    ;;
  4)
...
read -p "Enter 1, 2, 3, or 4: " build_tools_choice
...
case $build_tools_choice in
  ...
  3)
    ...
    ;;
  4)
    echo "Installing make, cmake, and GNU Autotools..."
    sudo apt install -y make cmake autoconf automake libtool
    ;;
  *)
...
echo "Installation completed successfully! Some references list:"

# References for C and C++ development
echo
echo "### References for C and C++ Development ###"
echo "- C Language Standard (ISO/IEC 9899:2018): https://www.iso.org/standard/74528.html"
echo "- C Language Comitee (ISO/IEC JTC1/SC22/WG14): http://www.open-std.org/jtc1/sc22/wg14/"
echo "- C++ Language Standard (ISO/IEC 14882:2020): https://www.iso.org/standard/79358.html"
echo "- C++ Language Comitee (ISO/IEC JTC1/SC22/WG21): http://isocpp.org/std/the-standard"
echo "- C (cprogramming.com): https://www.cprogramming.com"
echo "- C++ (cppreference.com): https://en.cppreference.com/w/"
echo "- GNU C Library Reference Manual: https://www.gnu.org/software/libc/manual/"
echo "- C FAQ: http://c-faq.com"
echo "- GNU Compiler Collection (GCC): https://gcc.gnu.org/onlinedocs/"
echo "- Clang: https://clang.llvm.org/docs/"
echo "- GNU C Library: https://www.gnu.org/software/libc/"
echo "- GNU Debugger (GDB): https://www.gnu.org/software/gdb/"
echo "- Data Display Debugger (DDD): https://www.gnu.org/software/ddd/"
echo "- CMake: https://cmake.org"
echo
echo "### Books ###"
echo
echo "# Classical Books #"
echo "- The C Programming Language (Brian W. Kernighan e Dennis M. Ritchie)"
echo "- The C++ Programming Language (Bjarne Stroustrup)"
echo
echo "# Beginner Books #"
echo "- Head First C"
echo "- The C Programming Language (Ritchie & Kernighan)"
echo "- C Programming: A Modern Approach (K.N. King)"
echo
echo "# Intermediate Books #"
echo "- Learn C the Hard Way"
echo "- The Art of Debugging with GDB, DDD and Eclipse"
echo "- Advanced Topics in C: Core Concepts in Data Structures"
echo
echo "# Advanced Books #"
echo "- The Linux Programming Interface"
echo "- Advanced Linux Programming"
echo "- Write Great Code (2 Volumes)"
echo "- Hacker's Delight"
echo
echo "### Others Online Resources ###"
echo "- Tenouk: http://www.tenouk.com"
echo "- Programming in C (Lecture Notes by Prof. Behrouz Forouzan): https://condor.depaul.edu/sjost/it212/documents/C_Programming_notes.pdf"
echo "- Linux Programming HOWTO: http://www.faqs.org/docs/Linux-HOWTO/Program-Library-HOWTO.html"
echo "- CS50's Introduction to Computer Science: https://cs50.harvard.edu/x/"
echo "- Modern C by Jens Gustedt: https://modernc.gforge.inria.fr"
echo "- C Programming at Wikibooks: https://en.wikibooks.org/wiki/C_Programming"
echo 
echo "### Others References ###"
echo "- Git: https://git-scm.com"
echo "- OpenSSL: https://www.openssl.org"
echo "- libcurl: https://curl.se/libcurl/"
echo "- Boost: https://www.boost.org"
echo "- SQLite: https://www.sqlite.org"
echo "- GTK: https://www.gtk.org"
echo "- OpenGL: https://www.opengl.org"
echo "- zlib: https://zlib.net"
echo "- ncurses: https://invisible-island.net/ncurses/"
echo "- libpcap: https://www.tcpdump.org"
echo "- Boost.Asio: https://think-async.com/Asio/"
echo
echo "###########################################"