...
########################################################################
# VISIT: https://github.com/ivan-hc/OBS-Studio-appimage
# SCRIPT CREDITS: https://portable-linux-apps.github.io
# DESCRIPTION: Software for video recording and live streaming (ArchImage)
...
APP=obs-studio
REPO="ivan-hc/OBS-Studio-appimage"
