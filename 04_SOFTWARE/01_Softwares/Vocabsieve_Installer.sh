...
########################################################################
# VISIT: https://github.com/FreeLanguageTools/vocabsieve
# SCRIPT CREDITS: https://portable-linux-apps.github.io
# TUTORIAL: https://www.youtube.com/watch?v=EHW-kBLmuHU
...
APP=vocabsieve
SITE="FreeLanguageTools/vocabsieve"
...
version=$(curl -Ls https://api.github.com/repos/FreeLanguageTools/vocabsieve/releases | jq '.' | grep browser_download_url | grep -i appimage | cut -d '"' -f 4 | head -1)
wget $version
