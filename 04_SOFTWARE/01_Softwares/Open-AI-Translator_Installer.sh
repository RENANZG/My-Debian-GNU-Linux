...
########################################################################
# VISIT: https://github.com/yetone/openai-translator
# SCRIPT CREDITS: https://portable-linux-apps.github.io
# 1. Make it executable:
# $ sudo chmod +x ~/Downloads/Open-AI-Translator_Installer.sh
# 2. Then run
# $ sudo bash ~/Downloads/Open-AI-Translator_Installer.sh
########################################################################

APP=open-ai-translator
REPO="yetone/openai-translator"
