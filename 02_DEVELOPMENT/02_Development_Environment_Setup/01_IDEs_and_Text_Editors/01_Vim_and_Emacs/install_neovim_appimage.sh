...
#######################################################################
# File Name    : install_neovim_appimage.sh
# Description  : This script automates the download, installation,
#                and setup of Neovim Stable AppImage. It also provides
#                bwrap (bubblewrap) sandboxing for secure execution.
#                Download URL is dynamically retrieved using regex to
#                abstract versioning for the latest stable release.
# Dependencies : curl, bubblewrap
# Usage        : • Make the script executable with:
#                 chmod +x install_neovim_appimage.sh
#                • Run the script with:
#                 bash install_neovim_appimage.sh
#                • To update the AppImage, run:
#                 bash $HOME/.local/share/neovim-stable/update.sh
#                • To remove the AppImage, run:
#                 bash $HOME/.local/share/neovim-stable/remove.sh
...
# Define variables for abstraction
APP_NAME="neovim-stable"
APP_DOWNLOAD_URL="https://github.com/neovim/neovim/releases"
