...
#######################################################################
# File Name    : install_neovim_nightly.sh
# Description  : This script automates the download, installation,
#                and setup of Neovim Nightly AppImage. It also provides
#                bwrap (bubblewrap) sandboxing for secure execution.
#                Download URL is dynamically retrieved using regex.
# Dependencies : curl, bubblewrap
# Usage        : • Make the script executable with:
#                 chmod +x install_neovim_nightly.sh
#                • Run the script with:
#                 bash install_neovim_nightly.sh
#                • To update the AppImage, run:
#                 bash $HOME/.local/share/neovim-nightly/update.sh
#                • To remove the AppImage, run:
#                 bash $HOME/.local/share/neovim-nightly/remove.sh
