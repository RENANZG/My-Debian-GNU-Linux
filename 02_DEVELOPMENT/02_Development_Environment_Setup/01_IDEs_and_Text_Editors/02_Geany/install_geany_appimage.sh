...
#######################################################################
# File Name    : install_geany_appimage.sh
...
#                  chmod +x install_geany_appimage.sh
#                • Run the script with:
#                  bash install_geany_appimage.sh
#                • To update the AppImage, run:
#                  bash $HOME/.local/share/geany/update.sh
#                • To remove the AppImage, run:
#                  bash $HOME/.local/share/geany/remove.sh
...
# Define variables
APP_NAME="freetube"
APP_DOWNLOAD_URL="https://api.github.com/repos/ecmu/geany.AppImage/releases"
