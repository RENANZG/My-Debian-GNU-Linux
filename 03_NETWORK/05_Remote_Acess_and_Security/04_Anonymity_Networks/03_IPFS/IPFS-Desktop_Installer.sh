...
#######################################################################
# File Name    : install_ipfs-desktop_appimage.sh
...
#                  chmod +x install_ipfs-desktop_appimage.sh
#                • Run the script with:
#                  bash install_ipfs-desktop_appimage.sh
#                • To update the AppImage, run:
#                  bash $HOME/.local/share/ipfs-desktop/update.sh
#                • To remove the AppImage, run:
#                  bash $HOME/.local/share/ipfs-desktop/remove.sh
...
APP_DOWNLOAD_URL="https://api.github.com/repos/ipfs/ipfs-desktop/releases"
