...
########################################################################
# File Name    : security_analysis_usb.sh
...
#                SUBSYSTEMS=="usb", RUN+="/usr/local/bin/usb-
#                virusscan.sh"
...
#                log file at:
#                /home/USER/USB_Virus/USB_Virus.txt
# Dependencies : clamav, yara, yara-python
# Usage        : • Make the script executable with:
#                sudo chmod +x /usr/local/bin/security_analysis_usb.sh
#                • To manually run the script:
#                sudo bash /usr/local/bin/security_analysis_usb.sh
