...
# "Juicity-Installer" (https://github.com/deathline94/Juicity-Installer) by deathline94 (https://github.com/deathline94) is licensed under Apache License Version 2.0 (https://www.apache.org/licenses/LICENSE-2.0.html)
