...
# USAGE          :
# Make it executable:
# $ sudo chmod +x ~/Downloads/Superslicer-prerelease-bin_Installer.sh
# Then run
# $ sudo bash ~/Downloads/Superslicer-prerelease-bin_Installer.sh
########################################################################


APP=superslicer-prerelease-bin
