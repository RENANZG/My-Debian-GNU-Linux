...
<pre><code><span>public</span> <span>class</span> <span>Hello</span>
<span>{</span>
...
<span>{</span>
System<span>.</span>out<span>.</span><span>println</span><span>(</span><span>"Hello"</span><span>)</span><span>;</span>
<span>}</span>
<span>}</span></code></pre>
</td>
<td>
<pre><code><span>print</span> <span>(</span><span>"Hello"</span><span>)</span></code></pre>
</td>
</tr>
<tr>
<td><strong>Syntax</strong></td>
...
<pre><code><span>class</span> <span>Example</span>
<span>{</span>
<span>public</span> <span>static</span> <span>void</span> <span>main</span> <span>(</span><span>String <span>[</span><span>]</span> args</span><span>)</span>
<span>{</span>
int x<span>=</span><span>10</span><span>;</span>
System<span>.</span>out<span>.</span><span>println</span><span>(</span>x<span>)</span><span>;</span>
<span>}</span>
<span>}</span></code></pre>
</td>
...
<pre><code>X <span>=</span> <span>45</span>
site <span>=</span> <span>"duckduckgo.com"</span></code></pre>
</td>
</tr>
<tr>
