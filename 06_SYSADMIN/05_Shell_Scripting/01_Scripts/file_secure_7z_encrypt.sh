...
#                 sudo bash /secure_7z_encrypt.sh /input/directory 
#                 /output/archive.7z
...
usage() {
    echo "Usage:"
    echo "  To encrypt: sudo bash /secure_7z_encrypt.sh <file_or_directory>"
    echo "  To shred after encrypting: sudo bash /secure_7z_encrypt.sh shred <file_or_directory>"
