...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Alduin_AppImage.sh
#  Then run
#   $ sudo bash ~/Downloads/Alduin_AppImage.sh
########################################################################
...
version=$(curl -Ls https://api.github.com/repos/Xstoudi/alduin/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
