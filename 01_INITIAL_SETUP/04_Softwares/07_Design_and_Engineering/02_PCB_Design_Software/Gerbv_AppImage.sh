...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Gerbv_AppImage.sh
#  Then run
#   $ sudo bash ~/Downloads/Gerbv_AppImage.sh
########################################################################
...
version=$(curl -Ls https://api.github.com/repos/m59peacemaker/gerbv-appimage/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
