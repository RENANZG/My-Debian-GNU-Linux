...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Circuitblocks_AppImage.sh
#  Then run
#   $ sudo bash ~/Downloads/Circuitblocks_AppImage.sh
########################################################################
...
set -u
APP=circuitblocks
SITE="CircuitMess/CircuitBlocks"
...
version=$(curl -Ls https://api.github.com/repos/CircuitMess/CircuitBlocks/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
