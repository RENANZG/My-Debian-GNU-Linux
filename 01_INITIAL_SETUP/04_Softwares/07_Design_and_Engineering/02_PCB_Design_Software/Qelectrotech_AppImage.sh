...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Qelectrotech_AppImage.sh
#  Then run
#   $ sudo bash ~/Downloads/Qelectrotech_AppImage.sh
########################################################################
...
set -u
APP=qelectrotech
SITE="qelectrotech/qelectrotech-source-mirror"
...
version=$(curl -Ls https://api.github.com/repos/qelectrotech/qelectrotech-source-mirror/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
