...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Kicad_AppImage.sh
#  Then run
#   $ sudo bash ~/Downloads/Kicad_AppImage.sh
########################################################################
...
set -u
APP=kicad
SITE="KarlZeilhofer/kicad-appimage"
...
version=$(curl -Ls https://api.github.com/repos/KarlZeilhofer/kicad-appimage/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
