...
# USAGE:
#  Make it executable:
#   $ sudo chmod +x ~/Downloads/Creality-print.sh
#  Then run
#   $ sudo bash ~/Downloads/Creality-print.sh
########################################################################
...
version=$(curl -Ls https://www.creality.com/pages/download-software | grep -Eo "(http|https)://[a-zA-Z0-9./?=_%:-]*" | sort -u | grep -i appimage)
wget $version
