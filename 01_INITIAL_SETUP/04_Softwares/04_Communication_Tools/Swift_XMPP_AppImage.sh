...
version=$(echo "https://www.swift.im/$(wget -q https://www.swift.im/downloads.html -O -| grep -i appimage | sort -u | grep -o -P '(?<=as well as an <a href=").*(?=">AppImage)')")
wget $version
