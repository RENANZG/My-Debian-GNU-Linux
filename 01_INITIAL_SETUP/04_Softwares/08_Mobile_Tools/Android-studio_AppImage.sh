...
########################################################################
# VISIT: https://github.com/zyrouge/android-studio-appimages
...
set -u
APP=android-studio
SITE="zyrouge/android-studio-appimages"
...
version=$(curl -Ls https://api.github.com/repos/zyrouge/android-studio-appimages/releases/latest | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
