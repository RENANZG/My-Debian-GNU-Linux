...
# ABOUT: Alvr AppImage for linux - Stream VR games from your PC to your headset via Wi-Fi

# AM INSTALL SCRIPT VERSION 3.5
set -u
APP=alvr-appimage
SITE="elpinguinoopensource/alvr-appimage"
...
version=$(curl -Ls https://api.github.com/repos/elpinguinoopensource/alvr-appimage/releases | sed 's/[()",{} ]/\n/g' | grep -oi "https.*mage$" | grep -vi "i386|i686|aarch64|arm64|armv7l" | head -1)
wget "$version" || exit 1
